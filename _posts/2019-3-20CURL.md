...
From now on we use *Contrastive Unsupervised Representation learning (CURL)* as the term for such methods that leverage similar pairs of data points and the goal is to analyze these methods.
