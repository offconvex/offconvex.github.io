...
I now suspect that much of the magic of deep learning happens due to the precise algorithm used, namely, the precise flavor of  gradient descent, and some/most of this magic may not even be formalizable as an explicit single objective that we can attack via optimization.  Thus the trajectory of optimization plays an important role, and it is not captured by the training objective. We're reminded of the old adage. 

> The journey is more important than the goal. 

Below I describe two new research directions that led to this viewpoint.
