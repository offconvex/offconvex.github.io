...
A biological neuron receives signals from multiple neurons, computes 
...
In biologically plausible NNs, learning rules must be **local**. This 
...
In the online setting, (1.3) can be solved by alternating minimization, 
